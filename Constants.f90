! This comes from Quantum Espresso ( implementation )
...
REAL(DP), PARAMETER :: EPSNOUGHT_SI = 1.0_DP / (MUNOUGHT_SI*C_SI**2) ! F m^-1
!
...
REAL(DP), PARAMETER :: T_AU = 1._DP/3.1577464E+5_DP
!
